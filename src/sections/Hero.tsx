...
export const HeroSection = () => {
  return <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
    <div className="absolute inset-0 [mask-image:linear-gradient(to-bottom, transparent, black_10%, black_70%, transparent"> {/* This div will help create a fade on the bottom. We use this div to control this div with a mask. the black 10% to 70% and then transparent means that the fade will come in quickly and then go out with a much smoother, longer fade. */}
      ...
      <HeroOrbit size={650} rotation={-15}>
        <div className="size-2 rounded-full bg-emerald-300/20" />
      </HeroOrbit>
    </div>
